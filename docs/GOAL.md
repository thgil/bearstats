...
| 7 | The baseline has shifted: bear population ~15,000 (2012) to ~54,000 (2025); hunters >70,000 (1970s) to <20,000. | Secondary sources (Japan Times, Britannica). | **Primary series**: MoE population estimates by year; MoE/prefecture hunting-licence counts by year; MoE capture (捕獲) counts, which we already hold. |
